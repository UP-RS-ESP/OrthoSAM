...
#vars
OutDIR='/DATA/vito/output/Ravi2_fnc_dw8/'
...
def nms(lst_msk,lst_score):
    #NMS filtering
    bboxes = torch.tensor([fnc.find_bounding_boxes(mask) for mask in lst_msk], device=DEVICE, dtype=torch.float)
...
del list_of_cleaned_groups_reseg_score_nms, list_of_nooverlap_mask, cleaned_groups
del masks, list_of_pred_iou,list_of_masks
